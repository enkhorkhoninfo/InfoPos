...
namespace InfoPos.Issue
{
    public partial class FormIssue : DevExpress.XtraEditors.XtraForm
    {
        ...
        public FormIssue(InfoPos.Core.Core core,long issueid,long customerno)
        {
            _core = core;
            _issueid = issueid;
        ...
        private void InitData()
        {
            try
            {
                ...
                ucToggleIssue.FieldLinkAdd("cboProjectID", 0, "ProjectID", "", true, false);
        ...
        private void SaveIssueData(bool isnew, ref bool cancel)
        {
            try
            {
                ...
                if (isnew)
                {
                    ...
                    #endregion
                    res = _core.RemoteObject.Connection.Call(_core.RemoteObject.User.UserNo, FileID, 310081, 310081, new object[] { NewValue,_customerno});
                    ResMain = res;
                ...
                else
                {
                    ...
                    #endregion
                    res = _core.RemoteObject.Connection.Call(_core.RemoteObject.User.UserNo, FileID, 310082, 310082, new object[] { NewValue });
                    ResMain = res;
