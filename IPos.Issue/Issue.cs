...
namespace IPos.Issue
{
    public class Issue : IModule
    {
            ...
            try
            {
                ...
                if (res.ResultNo == 0)
                {
                    ...
                    if (DT.Rows.Count != 0)
                    {
                        ...
                        res = SendMail("CRM Асуудал шинээр нэмэх", Body, ToUser);
                    }
                    #endregion
                }
                return res;
                ...
                if (res.ResultNo == 0)
                {
                    ...
                    if (DT.Rows.Count != 0)
                    {
                        ...
                        string Body = @"CRM Асуудал засагдав - " + IssueId.ToString()
                                        ...
                                        + "\r\n"
                                        + ">>   Яг одоо харуйцаж байгаа хэрэглэгч - " + rws["ASSIGNUSER"].ToString();
                        res = SendMail("CRM Асуудал засварлах", Body, ToUser);
                    }
                    #endregion
                }
                return res;
                ...
                if (ri.ReceivedParam.Length != 1)
                {
                    ...
                    if (res.ResultNo == 0)
                    {
                        ...
                        if (res.ResultNo == 0)
                        {
                            ...
                            switch (Convert.ToInt32(RiObj[5]))
                            {
                                case 1://comment
                            ...
                            if (res.ResultNo == 0)
                            {
                                ...
                                if (DT.Rows.Count != 0)
                                {
                                    ...
                                    string Body = @"CRM Асуудалын гүйлгээ - " + IssueId.ToString()
                                                    + "\r\n"
                                                    + "\r\n"
                                                    + "\r\n"
                                                    + "\r\n"
                                                    + "\r\n"
                                                    + ri.UserNo.ToString() + "-" + GetName(db, ri.UserNo) + " асуудал гүйлгээ хийв"
                                                    + "\r\n"
                                                    + "-----------------------------------------"
                                                    + "\r\n"
                                                    + "Төсөлийн нэр : " + rws["PROJECTNAME"].ToString()
                                                    ...
                                                    + ">>   Асуудалын төрөл - " + rws["ISSUETYPENAME"].ToString()
                                                    + "\r\n"
                                                    + ">>   Холбоо барисан төрөл - " + rws["CONTACTTYPENAME"].ToString()
                                                    + "\r\n"
                                                    + ">>   Гүйлгээний утга - " + Type
                                                    + "\r\n"
                                                    ...
                                                    + "\r\n"
                                                    + ">>   Яг одоо харуйцаж байгаа хэрэглэгч - " + rws["ASSIGNUSER"].ToString();
                                    res = SendMail("CRM Асуудалын гүйлгээ", Body, ToUser);
                                }
                                #endregion
                            }
                        }
                    ...
                    if (res.ResultNo == 0)
                    {
                        ...
                        if (res.ResultNo == 0)
                        {
                            ...
                            if (DT.Rows.Count != 0)
                            {
                                ...
                                string Body = @"CRM Асуудалын шилжүүллээ - " + IssueId.ToString()
                                                + "\r\n"
                                                + "\r\n"
                                                + "\r\n"
                                                + "\r\n"
                                                + "\r\n"
                                                + ri.UserNo.ToString() + "-" + GetName(db, ri.UserNo) + " асуудал шилжүүлэг хийв"
                                                + "\r\n"
                                                + "-----------------------------------------"
                                                + "\r\n"
                                                + "Төсөлийн нэр : " + rws["PROJECTNAME"].ToString()
                                                ...
                                                + "\r\n"
                                                + ">>   Яг одоо харуйцаж байгаа хэрэглэгч - " + rws["ASSIGNUSER"].ToString();
                                res = SendMail("CRM Асуудалын шилжүүлэг", Body, ToUser);
                            }
                            #endregion
                        }
                    }
        ...
        #endregion
        #region[ SEND MAIL ]
        Result SendMail(string Subject,string Body,string[] ToUser)
        {
            try
            {
                MailMessage msg = new MailMessage();
                msg.From = new MailAddress(SystemProp.MailFromUser);
