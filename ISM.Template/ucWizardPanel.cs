...
{
    public partial class ucWizardPanel : UserControl
    {
        ...
        public ISM.Template.Resource Resource
        {
            ...
            set
            {
                ...
                if (_resource != null)
                {
                    btnPrev.Image = _resource.GetBitmap("button_prev");
                    btnNext.Image = _resource.GetBitmap("button_next");
                    btnFinish.Image = _resource.GetBitmap("button_ok");
