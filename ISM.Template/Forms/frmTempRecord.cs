...
{
    public partial class frmTempRecord : Form
    {
        ...
        public frmTempRecord()
        {
            InitializeComponent();
        }
        private void frmTempRecord_Load(object sender, EventArgs e)
        {
            try
            {
                ToggleButtons();
        ...
        public delegate void delegateEventRefresh(ref DataSet ds);
        public event delegateEventRefresh EventRefresh;
        public void OnEventRefresh(ref DataSet ds)
        {
            if (EventRefresh != null) EventRefresh(ref ds);
        }
        ...
        {
            DialogResult d = MessageBox.Show("Бичлэгийг устгахдаа итгэлтэй байна уу?", this.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question);
