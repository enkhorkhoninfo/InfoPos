...
namespace ISM.Template.UserControls
{
    ...
    [ToolboxBitmap(typeof(ucWebBrowser), "Resources.HtmlEditor.bmp")]
    public sealed partial class ucWebBrowser : UserControl
    {
        ...
        private const string HTML_TITLE_EDIT = "Засах";
        private const string HTML_TITLE_VIEW = "Харах";
