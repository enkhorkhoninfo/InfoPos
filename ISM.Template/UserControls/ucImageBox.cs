...
namespace ISM.ImageTool
{
    ...
    [DefaultProperty("Image"), ToolboxBitmap(typeof(ucImageBox))]
    public partial class ucImageBox : ScrollableControl
    {
        ...
        public int Zoom
        {
            ...
            set
            {
                if (value < ucImageBox.MinZoom)
                    value = ucImageBox.MinZoom;
                else if (value > ucImageBox.MaxZoom)
                    value = ucImageBox.MaxZoom;
