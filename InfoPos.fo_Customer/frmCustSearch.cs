...
namespace InfoPos.fo_Customer
{
    public partial class frmCustSearch : Form
    {
        ...
        #endregion
        #region Constructors
        public frmCustSearch(InfoPos.Core.Core core)
        {
            try
            {
                InitializeComponent();
        ...
        public void DataColumnRefresh()
        {
            ...
            ISM.Template.FormUtility.Column_SetCaption(ref gridView1, 2, "Утас");
            ...
            ISM.Template.FormUtility.Column_SetCaption(ref gridView1, 6, "Хүйс");
        ...
        public Result DataRefresh(int pageno)
        {
            ...
            if (_remote != null)
            {
                res = _remote.Connection.Call(_remote.User.UserNo, 602, 602001, 120000, pageno - 1, _pagerows, param);
                if (res.ResultNo == 0)
                {
                    PageSet(pageno, res);
