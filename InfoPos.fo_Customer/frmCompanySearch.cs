...
namespace InfoPos.fo_Customer
{
    public partial class frmCompanySearch : Form
    {
        ...
        #endregion
        #region Constructors
        public frmCompanySearch(InfoPos.Core.Core core)
        {
            try
            {
                InitializeComponent();
        ...
        public void DataColumnRefresh()
        {
            ...
            ISM.Template.FormUtility.Column_SetCaption(ref gridView1, 1, "Байгууллагын нэр");
        ...
        public Result DataRefresh(int pageno)
        {
            ...
            if (_remote != null)
            {
                res = _remote.Connection.Call(_remote.User.UserNo, 602, 602003, 120000, pageno - 1, _pagerows, param);
                if (res.ResultNo == 0)
                {
                    PageSet(pageno, res);
        ...
        public Result Find(string custno, string cname, string reg)
        {
            Result res = null;
