...
{
    public partial class ucPledgeSearch : UserControl
    {
        #region Properties
        ...
        private void ucPledgeSearch_Load(object sender, EventArgs e)
        {
        ...
        public void DataColumnRefresh()
        {
            ...
            ISM.Template.FormUtility.Column_SetCaption(ref gridView1, 6, "Дугаар");
            ISM.Template.FormUtility.Column_SetCaption(ref gridView1, 7, "Ажилтан");
            ISM.Template.FormUtility.Column_SetCaption(ref gridView1, 8, "Огноо");
            ISM.Template.FormUtility.Column_SetCaption(ref gridView1, 9, "Төлөв");
            ISM.Template.FormUtility.Column_SetCaption(ref gridView1, 10, "Таг");
            ISM.Template.FormUtility.Column_SetCaption(ref gridView1, 11, "Багц");

            ISM.Template.FormUtility.Column_SetList(ref gridView1, 9, new string[] { "БАРЬЦААЛСАН","ЧӨЛӨӨЛСӨН"});
        ...
        public Result DataRefresh(int pageno)
        {
            ...
            if (_remote != null)
            {
                res = _remote.Connection.Call(_remote.User.UserNo, 500, 500009, 500009, pageno - 1, _pagerows, param);
                if (res.ResultNo == 0)
                {
                    PageSet(pageno, res);
        ...
        public Result Find(string custno, string pledgeno, string reg, string fname, string lname, string cname, string docno, string serialno)
        {
            Result res = null;
