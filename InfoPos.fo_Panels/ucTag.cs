    ...
    public partial class ucTag : UserControl
    {
        ...
        public ucTag()
        {
            try
            {
                ...
                _layoutfilename = string.Format(@"{0}\Data\Layout_{1}a.xml", Static.WorkingFolder, this.GetType().Name);
        ...
        {
            ISM.Template.FormUtility.Column_SetCaption(ref gridView1, 0, "Борл.№");
            ISM.Template.FormUtility.Column_SetCaption(ref gridView1, 1, "Сериал");
