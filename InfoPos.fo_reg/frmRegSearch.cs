...
{
    public partial class frmRegSearch : DevExpress.XtraEditors.XtraForm
    {
        #region Properties
        ...
        public void DataColumnRefresh()
        {
            ...
            ISM.Template.FormUtility.Column_SetCaption(ref gridView1, 11, "DocType", true);
            ISM.Template.FormUtility.Column_SetCaption(ref gridView1, 12, "Memo", true);
        ...
        public frmRegSearch(InfoPos.Core.Core core)
        {
            InitializeComponent();
