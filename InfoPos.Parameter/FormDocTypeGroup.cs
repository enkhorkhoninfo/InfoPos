...
{
    public partial class FormDocTypeGroup : Form
    {
        #region [ Variables ]
            Core.Core _core;
            int btn = 0;
            ...
            object[] OldValue;
        #endregion
        public FormDocTypeGroup(Core.Core core)
        {
            InitializeComponent();
            _core = core;
        ...
        void RefreshRiskGroupData()
        {
            ...
            try
            {
                ...
                res = _core.RemoteObject.Connection.Call(_core.RemoteObject.User.UserNo, 202, 150022, 150022, obj);
        ...
        void RefreshRiskCondData(int pRiskGroupID)
        {
            ...
            try
            {
                res = _core.RemoteObject.Connection.Call(_core.RemoteObject.User.UserNo, 202, 150027, 150027, new object[] { pRiskGroupID });
                if (res.ResultNo == 0 || res.ResultNo == 9110014)
                {
        ...
        void SetRiskGroupData()
        {
            ...
            gvwRiskGroup.Columns[0].Caption = "Документын бүлгийн дугаар";
        ...
        void SetRiskData()
        {
            ...
            gvwRisk.Columns[1].Caption = "Документын дугаар";
            ...
            gvwRisk.Columns[4].Caption = "Файлын нэр";
            gvwRisk.Columns[4].OptionsColumn.AllowEdit = false;
            gvwRisk.Columns[5].Caption = "Хөрвүүлэх төрөл";
            gvwRisk.Columns[5].OptionsColumn.AllowEdit = false;
            FormUtility.RestoreStateGrid(appname, formname, ref gvwRisk);
        }
        ...
        void SaveEdit(bool issave)
        {
            ...
            if (!checkType)
            {
                ...
                try
                {
                    ...
                    if (issave)
                    {
                        res = _core.RemoteObject.Connection.Call(_core.RemoteObject.User.UserNo, 202, 150024, 150024, new object[] { obj, FieldName });
                        msg = "Амжилттай хадгаллаа .";
                    }
                    else
                    {
                        res = _core.RemoteObject.Connection.Call(_core.RemoteObject.User.UserNo, 202, 150025, 150025, new object[] { obj,OldValue, FieldName });
            ...
            private void btnRiskGroupDelete_Click(object sender, EventArgs e)
                {
                    ...
                    try
                    {
                        ...
                        if (dr != null)
                        {
                            ...
                            res = _core.RemoteObject.Connection.Call(_core.RemoteObject.User.UserNo, 202, 150026, 150026, new object[] { RiskGroupID });
       ...
       private void btnJoin_Click_1(object sender, EventArgs e)
       {
           ...
           try
           {
               ...
               obj[0] = Static.ToInt(txtGroupID.EditValue);
               obj[1] = dt;
               res = _core.RemoteObject.Connection.Call(_core.RemoteObject.User.UserNo, 202, 150029, 150029, obj);
               msg = "Амжилттай хадгаллаа .";
               if (res.ResultNo == 0 || res.ResultNo == 9110014)
               {
                   RefreshRiskGroupData();
